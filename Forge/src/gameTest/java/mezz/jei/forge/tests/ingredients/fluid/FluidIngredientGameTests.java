...
public final class FluidIngredientGameTests {
	...
	public static void flowingFluidStacksAreInvalid(GameTestHelper gameTestHelper) {
		...
		FluidStack flowingWater = new FluidStack(Fluids.FLOWING_WATER, FluidAttributes.BUCKET_VOLUME);
		FluidStack flowingLava = new FluidStack(Fluids.FLOWING_LAVA, FluidAttributes.BUCKET_VOLUME);
