...
public class IngredientFilterTest {
	...
	@Nullable
	private WorldConfig toggleState;
	@Nullable
	...
	private void setup(boolean lowMemorySlowSearchEnabled) {
		...
		this.toggleState = new WorldConfig();
		IWorldConfig toggleState = this.toggleState;
	...
	public void testRecipeVisibilityUsesRecipeUid() {
		...
		TestIngredient hiddenIngredient = ingredients.get(0);
