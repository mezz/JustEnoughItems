...
public class BrewingHelper implements IPlatformBrewingHelper {
	...
	public void registerCategoryExtensions(
		...
		// Forge exposes vanilla brewing as a registry fallback recipe.
		// Its mixtures are discovered directly from PotionBrewing, so the fallback itself has no display recipe.
		brewingCategory.addExtension(VanillaBrewingRecipe.class, (recipe, recipeFactory) -> List.of());
	}
