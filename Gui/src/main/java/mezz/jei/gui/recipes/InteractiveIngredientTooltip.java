...
final class InteractiveIngredientTooltip implements IGuiInputLayer {
	...
	// Vanilla adds another 400 Z for each tooltip. Keep these additions within 1.18's 1000-deep GUI projection.
	...
	private ImmutableRect2i getNavigationArea() {
		ImmutableRect2i tooltipArea = this.ingredientGrid.getArea();
	...
	public Optional<IUserInputHandler> handleMouseScrolled(
		...
		if (this.controller.isActive(this) && this.recipesGui.isOpen() && isMouseOver(mouseX, mouseY)) {
