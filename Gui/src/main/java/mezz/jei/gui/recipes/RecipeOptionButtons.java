...
public class RecipeOptionButtons {
	...
	public RecipeOptionButtons(Runnable onValueChanged) {
		...
		GuiIconToggleButton bookmarksFirstButton = new RecipeSortStateButton(
			...
			textures.getBookmarksFirst(),
			new TranslatableComponent("jei.tooltip.recipe.sort.bookmarks.first.disabled"),
			new TranslatableComponent("jei.tooltip.recipe.sort.bookmarks.first.enabled"),
			onValueChanged
		);
		GuiIconToggleButton craftableFirstButton = new RecipeSortStateButton(
			...
			textures.getCraftableFirst(),
			new TranslatableComponent("jei.tooltip.recipe.sort.craftable.first.disabled"),
			new TranslatableComponent("jei.tooltip.recipe.sort.craftable.first.enabled"),
			onValueChanged
		);
	...
	public void draw(PoseStack poseStack, int mouseX, int mouseY, float partialTicks) {
		...
		{
			backgroundTab.draw(poseStack, this.area);
		}
