...
public interface IIngredientListOverlayContents extends IIngredientGridView, IIngredientGridPageNavigation, IRecipeFocusSource {
	 ...
	 */
	void drawBackground(GuiGraphics guiGraphics);

	/**
	 * Draws foreground elements for the ingredient-list contents.
	 */
	void drawForeground(Minecraft minecraft, GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks);

	/**
	 * Draws tooltips for the ingredient-list contents.
	 */
	void drawTooltips(Minecraft minecraft, GuiGraphics guiGraphics, int mouseX, int mouseY);
