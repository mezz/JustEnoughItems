...
public class LookupHistoryButton extends GuiIconToggleButton {
	...
	protected void getTooltips(JeiTooltip tooltip) {
		if (clientConfig.isLookupHistoryEnabled()) {
			tooltip.add(new TranslatableComponent("jei.tooltip.lookupHistory.disable"));
		} else {
			tooltip.add(new TranslatableComponent("jei.tooltip.lookupHistory.enable"));
		}
		tooltip.add(
			new TranslatableComponent("jei.tooltip.lookupHistory.usage")
