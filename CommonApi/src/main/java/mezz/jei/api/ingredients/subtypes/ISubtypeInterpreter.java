...
public interface ISubtypeInterpreter<T> {
	 ...
	 * This should account for NBT, capabilities, and anything else that's relevant.
	 *
	 * The returned value must implement {@link Object#equals(Object)} and {@link Object#hashCode()}
