...
public interface IAdvancedRegistration {
	 ...
	 * @since 10.6.0
	 */
	default <T> void addRecipeCategoryDecorator(RecipeType<T> recipeType, IRecipeCategoryDecorator<T> decorator) {
	 ...
	 * @since 10.61.0
	 */
	default void addRecipeButtonFactory(IRecipeButtonControllerFactory recipeButtonControllerFactory) {
