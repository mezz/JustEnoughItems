...
public interface IGuiHelper {
	 ...
	 *
	 * @since 10.20.0
	 * @deprecated Use {@link #createDrawableSprite(TextureAtlas, ResourceLocation, int, int)} instead.
	 ...
	 * {@link IIngredientRenderer#render(com.mojang.blaze3d.vertex.PoseStack, Object, int, int)}
	 ...
	 */
	@Deprecated(since = "10.48.0", forRemoval = true)
