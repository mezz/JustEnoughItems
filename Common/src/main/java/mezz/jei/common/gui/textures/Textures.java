...
public class Textures {
	...
	public Textures(JeiGuiSpriteManager guiSpriteManager) {
		...
		IDrawableStatic rawShapelessIcon = createGuiSprite("icons/shapeless_icon_v2");
		this.shapelessIcon = new HighResolutionDrawable(rawShapelessIcon, 4);

		this.arrowPrevious = createGuiSprite("icons/arrow_previous_v2");
		this.arrowNext = createGuiSprite("icons/arrow_next_v2");
	...
	private IDrawableStatic createGuiSprite(String name) {
		...
		return new DrawableSprite(guiSpriteManager, location);
	}
