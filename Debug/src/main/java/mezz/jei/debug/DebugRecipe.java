...
public class DebugRecipe {
	...
	public DebugRecipe() {
		this(Component.literal("test"), false, List.of());
	}

	private DebugRecipe(Component buttonText, boolean slotDisplayComparison, List<ItemStack> largeIngredientList) {
	...
	public static DebugRecipe createSlotDisplayComparison() {
		return new DebugRecipe(Component.literal("compare"), true, List.of());
	}
	...
	public static DebugRecipe createLargeIngredientList(IIngredientManager ingredientManager) {
		...
		return new DebugRecipe(Component.literal("10k"), false, ingredients);
	}
