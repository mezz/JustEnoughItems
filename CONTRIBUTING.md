...
Keep changes in the module that owns the behavior. Avoid moving code between Common, Gui, Library, Fabric, Forge, NeoForge, and their API source sets unless the change specifically requires it.
...
flowchart TB
    subgraph published["Published code modules"]
        ...
        subgraph loaders["Loader packages"]
            ...
            Forge["Forge<br/>API + packaged mod"]
        end
    end
    ...
    class Fabric,Forge,NeoForge package
