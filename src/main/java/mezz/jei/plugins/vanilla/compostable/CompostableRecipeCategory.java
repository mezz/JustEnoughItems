...
public class CompostableRecipeCategory implements IRecipeCategory<CompostableRecipe> {
	...
	public CompostableRecipeCategory(IGuiHelper guiHelper) {
		...
		localizedName = new TranslationTextComponent("gui.jei.category.compostable");
	}
	...
	@Override
	public void draw(CompostableRecipe recipe, MatrixStack matrixStack, double mouseX, double mouseY) {
		...
		minecraft.font.draw(matrixStack, text, 24, 5, 0xFF808080);
	}
}
