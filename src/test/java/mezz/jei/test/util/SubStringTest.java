...
public class SubStringTest {
	...
	public void testNotIsPrefixAndStartsWith() {
		...
		List<SubString> invalidPrefixes = ImmutableList.of(
	...
	public void testEmptyPrefix() {
		...
		List<SubString> emptyPrefixes = ImmutableList.of(
			new SubString(""),
