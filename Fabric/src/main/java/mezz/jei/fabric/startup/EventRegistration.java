...
public class EventRegistration {
	...
	private void beforeRender(Screen screen, PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
		if (guiEventHandler != null) {
	...
	private static boolean hasJeiKeyboardFocus() {
		return Internal.getJeiRuntime().getIngredientListOverlay().hasKeyboardFocus();
	}
}
