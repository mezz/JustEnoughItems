...
public class JeiCharTypedEvents {
	public static final Event<BeforeCharTyped> BEFORE_CHAR_TYPED = EventFactory.createArrayBacked(BeforeCharTyped.class, callbacks -> (windowHandle, event) -> {
	...
	public static final Event<AfterCharTyped> AFTER_CHAR_TYPED = EventFactory.createArrayBacked(AfterCharTyped.class, callbacks -> (windowHandle, event) -> {
