...
public class TestClientConfig implements IClientConfig {
	...
	private final IConfigValue<Boolean> searchCompletionEnabled = value("searchCompletionEnabled", true);
	private final IConfigValue<Boolean> searchCompletionSuggestionsWhenEmptyEnabled = value("searchCompletionSuggestionsWhenEmptyEnabled", true);
