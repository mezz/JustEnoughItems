...
public final class FluidIngredientGameTests {
	...
	public static void emptyAndFlowingFluidStacksAreInvalid(JeiGameTestHelper helper) {
		...
		acceptor.addIngredient(NeoForgeTypes.FLUID_STACK, FluidStack.EMPTY);
		acceptor.addIngredient(NeoForgeTypes.FLUID_STACK, emptyFluid);
		acceptor.addIngredient(NeoForgeTypes.FLUID_STACK, zeroAmountWater);
		acceptor.addIngredient(NeoForgeTypes.FLUID_STACK, flowingWater);
		acceptor.addIngredient(NeoForgeTypes.FLUID_STACK, flowingLava);
	...
	public static void nonEmptyFluidStackIsAccepted(JeiGameTestHelper helper) {
		...
		acceptor.addIngredient(NeoForgeTypes.FLUID_STACK, water);
