...
public class JeiShapedRecipeBuilder implements IJeiShapedRecipeBuilder {
	...
	public JeiShapedRecipeBuilder(List<ItemStack> results) {
		this(null, results);
	}

	public JeiShapedRecipeBuilder(@Nullable ResourceLocation id, List<ItemStack> results) {
	...
	public JeiShapedRecipe build() {
		...
		return new JeiShapedRecipe(recipeId, this.group, width, height, inputs, this.results);
	}
