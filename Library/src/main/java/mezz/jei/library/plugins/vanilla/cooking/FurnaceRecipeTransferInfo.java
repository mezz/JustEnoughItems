...
public class FurnaceRecipeTransferInfo implements IRecipeTransferInfo<FurnaceMenu, Object> {
	@Override
	public Class<FurnaceMenu> getContainerClass() {
	...
	public RecipeType<Object> getRecipeType() {
		return (RecipeType) RecipeTypes.SMELTING;
	}
	...
	public ResourceLocation getRecipeCategoryUid() {
		return RecipeTypes.SMELTING.getUid();
	}
	...
	private static boolean hasSpecificFuel(Object recipe) {
		return recipe instanceof JeiSmeltingRecipe smeltingRecipe &&
			!smeltingRecipe.getFuel().isEmpty();
	}
}
