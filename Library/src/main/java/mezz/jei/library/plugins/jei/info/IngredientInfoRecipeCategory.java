...
public class IngredientInfoRecipeCategory extends AbstractRecipeCategory<IJeiIngredientInfoRecipe> {
	...
	public IngredientInfoRecipeCategory(Textures textures) {
		super(
			...
			new TranslatableComponent("gui.jei.category.itemInformation"),
	...
	@Override
	public void createRecipeExtras(IRecipeExtrasBuilder builder, IJeiIngredientInfoRecipe recipe, IRecipeSlotsView recipeSlotsView, IFocusGroup focuses) {
		int yPos = 22;
