...
public final class PluginLoader {
	...
	public static SubtypeManager registerSubtypes(StartData data) {
		...
		PluginCaller.callOnPlugins("Registering legacy fluid subtypes", plugins, p -> registerLegacyFluidSubtypes(p, subtypeRegistration));
	...
	public static IRecipeTransferManager createRecipeTransferManager(
		...
		CraftingRecipeCategory craftingCategory = vanillaPlugin.getCraftingCategory()
			.orElseThrow(() -> new NullPointerException("vanilla crafting category"));
		IRecipeTransferHandlerHelper handlerHelper = new RecipeTransferHandlerHelper(stackHelper, connectionToServer, craftingCategory);
	...
	public static RecipeManager createRecipeManager(
		...
		return new RecipeManager(recipeManagerInternal, ingredientManager, recipeButtonControllerFactories);
	}
}
