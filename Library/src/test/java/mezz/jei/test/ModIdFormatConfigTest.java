...
public class ModIdFormatConfigTest {
	...
	public void testDetectModNameTooltipFormattingIgnoresItemNameLine() {
		...
		List<Component> tooltip = List.of(
			new TextComponent(ModIds.MINECRAFT_NAME)
		);
	...
	public void testDetectModNameTooltipFormattingUsesLaterModNameLine() {
		...
		List<Component> tooltip = List.of(
			new TextComponent("Apple"),
			new TextComponent("Food"),
			new TextComponent(ModIds.MINECRAFT_NAME).withStyle(ChatFormatting.BLUE)
		);
	...
	public void testDetectModNameTooltipFormattingWithLegacyFormatting() {
		...
		List<Component> tooltip = List.of(
			new TextComponent("Apple"),
			new TextComponent(ChatFormatting.BLUE + ModIds.MINECRAFT_NAME)
		);
	...
	public void testDetectModNameTooltipFormattingIgnoresStyleOutsideModName() {
		...
		List<Component> tooltip = List.of(
			new TextComponent("Apple"),
			new TextComponent("")
				.append(new TextComponent("Mod: ").withStyle(ChatFormatting.RED))
				.append(new TextComponent(ModIds.MINECRAFT_NAME).withStyle(ChatFormatting.BLUE))
		);
	...
	public void testDetectModNameTooltipFormattingWithStyleOnPrefixAndModNameSegment() {
		...
		List<Component> tooltip = List.of(
			...
			new TextComponent("")
				.append(new TextComponent("Mod").withStyle(ChatFormatting.RED))
				.append(new TextComponent("name: " + ModIds.MINECRAFT_NAME).withStyle(ChatFormatting.BLUE))
		);
	...
	public void testDetectModNameTooltipFormattingWithModNameSplitAcrossBlueComponents() {
		...
		List<Component> tooltip = List.of(
			new TextComponent("Apple"),
			new TextComponent("")
				.append(new TextComponent("Mine").withStyle(ChatFormatting.BLUE))
				.append(new TextComponent("craft").withStyle(ChatFormatting.BLUE))
		);
	...
	public void testDetectModNameTooltipFormattingWithModNameSplitAcrossStyledComponents() {
		...
		List<Component> tooltip = List.of(
			new TextComponent("Apple"),
			new TextComponent("")
				.append(new TextComponent("Mine").withStyle(ChatFormatting.BLUE, ChatFormatting.ITALIC))
				.append(new TextComponent("craft").withStyle(ChatFormatting.BLUE, ChatFormatting.ITALIC))
		);
	...
	public void testDetectModNameTooltipFormattingWithInconsistentModNameStyling() {
		...
		List<Component> tooltip = List.of(
			...
			new TextComponent("")
				.append(new TextComponent("Mine").withStyle(ChatFormatting.BLUE))
				.append(new TextComponent("craft").withStyle(ChatFormatting.ITALIC))
		);
