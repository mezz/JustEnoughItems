...
public class StyledTextHelperTest {
	...
	public void testReplaceFirstWithNoMatch() {
		...
		Component text = new TextComponent("No matching text")
	...
	public void testReplaceFirstWithLegacyFormatting() {
		...
		Component text = new TextComponent(ChatFormatting.BLUE + TARGET);
	...
	public void testGetStyledTextSegments() {
		...
		Component text = new TextComponent("")
			.append(new TextComponent(LABEL).withStyle(ChatFormatting.RED))
			.append(new TextComponent(TARGET).withStyle(ChatFormatting.BLUE));
		...
		StyledTextHelper.StyledTextSegment prefix = result.get(0);
	...
	public void testGetStyledTextSegmentsStripsLegacyFormattingForPlainTextRange() {
		...
		StyledTextHelper.StyledTextSegment segment = result.get(0);
	...
	public void testGetTextRangeFindsTargetAcrossSegments() {
		...
		List<StyledTextHelper.StyledTextSegment> segments = StyledTextHelper.getStyledTextSegments(
			new TextComponent("")
				.append(new TextComponent(TARGET_START).withStyle(ChatFormatting.BLUE))
				.append(new TextComponent(TARGET_END).withStyle(ChatFormatting.BLUE))
		);
	...
	public void testGetTextRangeReturnsEmptyForMissingTarget() {
		...
		List<StyledTextHelper.StyledTextSegment> segments = StyledTextHelper.getStyledTextSegments(
			new TextComponent("No matching text")
		);
	...
	public void testReplaceFirstWithComponentStyle() {
		...
		Component text = new TextComponent(TARGET)
	...
	public void testReplaceFirstWithNonLegacyTextColor() {
		...
		Component text = new TextComponent(TARGET)
			.withStyle(Style.EMPTY.withColor(TextColor.fromRgb(0x12_34_56)));
	...
	public void testReplaceFirstWithStyleOnPrefixAndTargetSegment() {
		...
		Component text = new TextComponent("")
			.append(new TextComponent("Pre").withStyle(ChatFormatting.RED))
			.append(new TextComponent("fix: " + TARGET).withStyle(ChatFormatting.BLUE));
	...
	public void testReplaceFirstWithTargetSplitAcrossMatchingComponents() {
		...
		Component text = new TextComponent("")
			.append(new TextComponent(TARGET_START).withStyle(ChatFormatting.BLUE, ChatFormatting.ITALIC))
			.append(new TextComponent(TARGET_END).withStyle(ChatFormatting.BLUE, ChatFormatting.ITALIC));
	...
	public void testReplaceFirstWithTargetSplitAcrossDifferentStyles() {
		...
		Component text = new TextComponent("")
			.append(new TextComponent(TARGET_START).withStyle(ChatFormatting.BLUE))
			.append(new TextComponent(TARGET_END).withStyle(ChatFormatting.ITALIC));
	...
	public void testReplaceFirstWithSegmentsAndRange() {
		...
		List<StyledTextHelper.StyledTextSegment> segments = StyledTextHelper.getStyledTextSegments(
			new TextComponent(LABEL + TARGET).withStyle(ChatFormatting.BLUE)
		);
	...
	public void testReplaceFirstWithStyledSuffixAfterTarget() {
		...
		Component text = new TextComponent(TARGET + " suffix")
			.withStyle(ChatFormatting.BLUE);
	...
	public void testReplaceFirstOnlyReplacesFirstTarget() {
		...
		Component text = new TextComponent(TARGET + " " + TARGET)
			.withStyle(ChatFormatting.BLUE);
