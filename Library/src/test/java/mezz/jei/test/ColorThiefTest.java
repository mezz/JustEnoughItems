...
public class ColorThiefTest {
	...
	private static void setPixel(NativeImage image, int x, int y, int argbColor) {
		image.setPixelRGBA(x, y, argbToNativeAbgr(argbColor));
	}

	private static int argbToNativeAbgr(int argbColor) {
		int alpha = argbColor & 0xFF000000;
		int red = (argbColor >>> 16) & 0xFF;
		int green = argbColor & 0x0000FF00;
		int blue = (argbColor & 0xFF) << 16;
